...
module Komonzu::Command
  class Auth < Base
    ...
    def init_komonzu
      client = Komonzu::Client.new(user, password, host)
    ...
    def host
      ENV['KOMONZU_HOST'] || 'komonzu.heroku.com'
    end
    ...
    def credentials_file
      "#{home_directory}/.komonzu/credentials"
    end
    ...
    def ask_for_credentials
      puts "Enter your Komonzu credentials."
    ...
    def check_for_associated_ssh_key
      ...
      when 1 then
        ...
        display "Would you like to associate it with your Komonzu account? [Yn] ", false
